...
def handle_block_proposal(client, proposal_data):
    try:
        ...
        if blockchain.current_proposer == "smart_lock" and validate_block(proposed_block, latest_block):
            ...
            print("Block proposal rejected: Not Smart Lock's turn or invalid block.")
...
def main():
    ...
    try:
        ...
        while True:
            ...
            if current_time - last_publish_time >= 10 and blockchain.current_proposer == "smart_lock":
